...
class BookStoreTest < Minitest::Test
  ...
  def test_set_store
    books = [0, 2, 5, 5, 3, 1]
    # assert_equal(8, BookStore.num_sets(books, 2))
    # assert_equal(1, BookStore.num_sets(books, 5))
    # assert_equal(5, BookStore.num_sets(books, 3))
    # assert_equal(3, BookStore.num_sets(books, 4))
    assert_equal(16, BookStore.num_sets(books, 1))
  end
end
